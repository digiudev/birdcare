@extends('sb-admin.layouts.plane')
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <div>
                                        @include('sb-admin.widgets.progress', array('animated'=> true, 'class'=>'success', 'value'=>'40'))
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <div>
                                        @include('sb-admin.widgets.progress', array('animated'=> true, 'class'=>'info', 'value'=>'20'))
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <div>
                                        @include('sb-admin.widgets.progress', array('animated'=> true, 'class'=>'warning', 'value'=>'60'))
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <div>
                                        @include('sb-admin.widgets.progress', array('animated'=> true,'class'=>'danger', 'value'=>'80'))
