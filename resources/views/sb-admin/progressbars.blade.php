...
<div class="row">
	<div class="col-sm-6">
		...
		<h3>Regular</h3>
		@include('sb-admin.widgets.progress', array('class'=> '', 'value'=>'47'))

		<h3>With label</h3>
		@include('sb-admin.widgets.progress', array('class'=> '', 'value'=>'47', 'badge'=>true))
		@endsection
	...
	<div class="col-sm-6">
		...
		@include('sb-admin.widgets.progress', array('class'=> 'success', 'value'=>'97'))
		@include('sb-admin.widgets.progress', array('class'=> 'info', 'value'=>'52'))
		@include('sb-admin.widgets.progress', array('class'=> 'warning', 'value'=>'31'))
		@include('sb-admin.widgets.progress', array('class'=> 'danger', 'value'=>'16'))
		@endsection
...
<div class="rpw">
	<div class="col-sm-6">
		...
		@include('sb-admin.widgets.progress', array('class'=> 'success', 'striped'=> true, 'value'=>'97'))
		@include('sb-admin.widgets.progress', array('class'=> 'info', 'striped'=> true, 'value'=>'52'))
		@include('sb-admin.widgets.progress', array('class'=> 'warning', 'striped'=> true, 'value'=>'31'))
		@include('sb-admin.widgets.progress', array('class'=> 'danger', 'striped'=> true, 'value'=>'16'))
		@endsection
