...
@section('section')
            ...
            <div class="row">
                ...
                @section ('pane2_panel_body')
                    ...
                    <!-- /.panel -->
                @endsection
                @include('sb-admin.widgets.panel', array('header'=>true, 'as'=>'pane2'))
                </div>
                <!-- /.col-lg-8 -->
                <div class="col-lg-4">
                    ...
                    @endsection
                    @include('sb-admin.widgets.panel', array('header'=>true, 'as'=>'cchart11'))
                    ...
                    @endsection
                    @include('sb-admin.widgets.panel', array('header'=>true, 'as'=>'pane1'))
                    ...
                    <!-- /.panel .chat-panel -->
                    @endsection
                    @include('sb-admin.widgets.panel', array('header'=>true, 'as'=>'pane3'))
                </div>
